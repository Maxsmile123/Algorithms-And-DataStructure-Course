...
void Fs::MakeDir(const std::string& /*path*/, bool /*is_create_parents = false*/
) {
    // Not implemented
}

auto Fs::Split(const std::string& /*str*/, const std::string& /*splitter*/) -> std::vector<std::string> {
...
void Fs::WriteToFile(const std::string& /*path*/, bool /*is_overwrite = false*/, std::ostringstream& /*stream*/
) {
    // Not implemented
}
